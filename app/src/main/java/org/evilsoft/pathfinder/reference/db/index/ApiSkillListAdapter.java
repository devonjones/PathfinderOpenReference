...
public class ApiSkillListAdapter {
	public SQLiteDatabase database;
	public Context context;

	public ApiSkillListAdapter(SQLiteDatabase database, Context context) {
	...
	static {
		...
		columns.add("armor_check_penalty");
		columns.add("trained_only");
		translation.put("_id", "index_id as _id");
		translation.put("content_url", "url as content_url");
		translation.put("attribute", "attribute as skill_attribute");
		translation.put("armor_check_penalty",
				"armor_check_penalty as skill_armor_check_penalty");
		translation.put("trained_only", "trained_only as skill_trained_only");
	}
