...
public class ExpandableListFragment extends Fragment implements OnCreateContextMenuListener,
	 ...
	 * layout. If doing so, the returned view hierarchy <em>must</em> have a ListView whose id is
	 * {@link android.R.id#list android.R.id.list} and can optionally have a sibling view id {@link android.R.id#empty
	 ...
	 * {@link android.R.layout#list_content} in your layout file, so that you continue to retain all of the standard
	 * behavior of ListFragment. In particular, this is currently the only way to have the built-in indeterminant
