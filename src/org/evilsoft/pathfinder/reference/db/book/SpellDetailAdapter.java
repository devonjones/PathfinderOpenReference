...
public class SpellDetailAdapter {
	...
	public Cursor fetchSpellDetails(Integer section_id) {
		...
		sb.append("SELECT school, subschool, descriptor_text, level_text, casting_time,");
		sb.append("  preparation_time, range, duration, saving_throw, spell_resistance, as_spell_id");
