...
public class SkillContentProvider extends AbstractContentProvider {
	...
	public Cursor getSkillList(String[] projection, String selection,
			String[] selectionArgs, String sortOrder) {
		return dbWrangler.getIndexDbAdapter().getApiSkillListAdapter()
				.getSkills(projection, selection, selectionArgs, sortOrder);
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		if (initializeDatabase()) {
			...
			case 1:
				return getSkillList(projection, selection, selectionArgs,
						sortOrder);
